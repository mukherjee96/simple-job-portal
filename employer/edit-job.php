        ...
        <div class="content-wrap container-fluid">
            ...
            <div class="container mt-3">
                <form action="#" method="POST" id="jobAddForm">
                    <h4 class="mt-4">Job Details</h4><hr><br>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <?php
                                echo'
                                    <input type="number" class="form-control" id="experience" name="experience" value="'.$row["experience"].'" required>
                                ';
                            ?>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <h4 class="mt-4">Technologies</h4><hr><br>
                    <div class="row">
                        <div class="col-md-12">
